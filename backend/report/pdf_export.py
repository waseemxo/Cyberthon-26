...
# Color palette
CLR_BG = HexColor("#0f1117")
CLR_PRIMARY = HexColor("#6d28d9")
...
def generate_pdf(report: ForensicReport) -> bytes:
    ...
    # Title
    elements.append(Paragraph("DeepTrace Forensic Report", styles["ReportTitle"]))
    ...
    elements.append(Paragraph(
        "Generated by DeepTrace — AI Content Forensics Platform",
